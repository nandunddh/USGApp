  ...
  const UpComingConferences = () => {
    ...
    return (
      <ScrollView>
        <View>
          {notificationDesc &&
            notificationDesc.map((notificationDesc, index) => {
              return (
                  ...
                  <View style={{ flexDirection: 'row', flex: 1 }}>
                    ...
                    >
                      ...
                      <Text
                        ...
                        onPress={() => {
                          Linking.openURL(`${notificationDesc.url}`)
                        }}
                      >
                        Join Now
                      </Text>
      ...
      <ScrollView>
        ...
        >
          <FlatList
            ...
            renderItem={({ item }) => <HandleUrl item={item} />}
            horizontal
          ...
          >
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <View style={{ marginHorizontal: 15 }}>
                <Text
                  style={{ fontSize: 18, textAlign: 'justify', lineHeight: 25 }}
                >
